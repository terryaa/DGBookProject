...
/**
 클래스명 : public class  MyDealingData
 주된기능 : 내가 거래중인 책정보인 책제목, 저자, 출판사를 DB로부터 직접적으로 받는 기능
 ...
 메소드 :
 public static List< MyDealingData> getListData()
 * 매개변수:
 * 기능 : MyDealingData 객체에 데이터를 설정(set)한고 반환한다.
 */

public class MyDealingData {
    ...
    public static List<MyDealingListItem> getListData(){
